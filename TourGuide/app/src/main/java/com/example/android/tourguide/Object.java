...
public class Object {
    ...
    public Object(String ObjectName, String ObjectAddress, String ObjectDescription) {
        mObjectName = ObjectName;
        mObjectAddress = ObjectAddress;
        mObjectDescription = ObjectDescription;
    }

    public Object(String ObjectName, String ObjectAddress, int imageResourceId, String ObjectDescription) {
        mObjectName = ObjectName;
        mObjectAddress = ObjectAddress;
