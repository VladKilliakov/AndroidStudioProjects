        ...
        try {
            ...
            for (int i = 0; i < articleArray.length(); i++) {
                ...
                if (currentArticle.has("webPublicationDate")) {
                    publicationDate = currentArticle.getString("webPublicationDate");
                    String[] PDlist = publicationDate.split("T");
                    publicationDate = PDlist[0] + ", " +
                            PDlist[1].substring(0, (PDlist[1].length() - 1));
                }
                ...
                Article article = new Article(title, author, section, publicationDate, url);
